...
from utils import validation, validation_val,save_val
import os
import numpy as np
import random
...
val_data_loader = DataLoader(ValData(val_data_dir,val_filename), batch_size=val_batch_size, shuffle=False, num_workers=0)
...
val_psnr, val_ssim = save_val(net, val_data_loader, device, exp_name,category, save_tag=True)
