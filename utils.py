...
def save_val(net, val_data_loader, device, exp_name, category, save_tag=False):
...
def custom_valildation_val(net, val_data_loader, device, exp_name, category, save_tag=False):
